                ...
                {groups.length === 0 ? (
                    ...
                    groups.map((group: any) => (
                        <Link key={group.id} href={`/subscriptions/${group.id}`} className="group block">
                            <Card
                                className="p-4 sm:p-6 hover:bg-white/10 transition-colors flex items-center justify-between shadow-lg"
                                variant="default"
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs sm:text-sm text-zinc-400">
                                            {group.memberCount} amigos · {group.paidCount}/{group.memberCount} pagaron ·
                                            día {group.billing_cycle_day}
                                        </p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="font-bold text-base sm:text-lg text-indigo-400">
