        ...
        <div className="animate-in fade-in zoom-in-95 duration-500 max-w-2xl mx-auto">
            ...
            <Card className="p-6 mt-6 text-sm text-zinc-400 border border-white/5" variant="default">
                ...
                <p className="leading-relaxed mb-4">
                    Para generar el link en los mensajes de WhatsApp, agregá en <code className="text-zinc-300">.env.local</code>:
                </p>
                ...
                <p className="leading-relaxed mb-4">
                    ...
                    <code className="text-zinc-300">SUPABASE_SERVICE_ROLE_KEY</code> y configurá el webhook en
                    MP apuntando a <code className="text-zinc-300">/api/webhooks/mercadopago</code> (ver README).
                </p>
                <p className="leading-relaxed mb-4">
                    Obtenelo en{' '}
                    <a
                    ...
                    {' '}(tu aplicación → Credenciales → Access Token). Reiniciá <code className="text-zinc-300">npm run dev</code> después de guardar.
                </p>
                ...
                <p className="leading-relaxed">
                    ...
                    la suma al monto que paga tu amigo, para que vos recibas la cuota completa. Podés ajustar el porcentaje
                    con la variable <code className="text-zinc-300">MERCADOPAGO_FEE_PERCENT</code> en tu archivo de entorno.
                </p>
            </Card>
        </div>
    )
